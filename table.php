...
<body style="background-color: #D0D0D0; ">
    ...
    <div class="container mt-2 mb-2">
        ...
        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-search-clear-button="true" data-url="data2.json" data-show-print="true" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" data-show-jump-to="true">
            <thead>
                <tr> 
                    <th data-field="date" data-sortable="false">日期</th>
                    <th data-field="overage" data-sortable="true">付款金額</th>
