            ...
            <form action="" method="POST">
                ...
                if (empty($_SESSION['user'])) {
                    ...
                    if (isset($_POST['Submit'])) {
                        $acc = $_POST['User'];
                        $pwd = $_POST['Pwd'];
                        $sql = "Select * from member where user = '$acc' and pwd = '$pwd'";
                        ...
                        if ($row = mysqli_fetch_array($obj)) {
                            ...
                            var_dump($_SESSION);
                            // 重導到相關頁面
                            header("Location: https://fbbot.youcanbemama.com/tworder/index.php");
                        } else {
                    ...
                    echo 'window.location.href = "https://fbbot.youcanbemama.com/tworder/index.php";';
                    echo '</script>';
